...
#define pin_buzz  10           //pin10 conectado al buzzer
...
String contrasenaCerradura = "18210777*";   //Variable donde almaceno la contraseña definida por el sistema
...
void loop()
{
  ...
  if(key)
  {
    ...
    if(key == '*')
    {
      ...
      {
        lcdCerradura.setCursor(0,1);
        lcdCerradura.print("C. correcta");
        ON(led_verd);
        OFF(led_rojo);
        tone(pin_buzz,1318.51,500);
        delay(250);
        tone(pin_buzz,1046.50,500);
        ON(led_verd);
      ...
      {
        lcdCerradura.setCursor(0,1);
        lcdCerradura.print("C. incorrecta");
        delay(1000);
        lcdCerradura.setCursor(0,1);
        lcdCerradura.print("P.Cerrada       ");
        tone(pin_buzz,1046.50,250);
        delay(250);
        tone(pin_buzz,1318.51,250);
        delay(250);
        tone(pin_buzz,2093,250);
        delay(250);
        tone(pin_buzz,1975.53,250);
         delay(250);
        tone(pin_buzz,1547.98,250);
        
        OFF(led_verd);
        ON(led_rojo);

        Serial.println("C. incorrecta");
        ServoCerradura.write(0);
      }
